defmodule DixordWeb.UserControllerTest do
  use DixordWeb.ConnCase

  alias Dixord.Accounts

  @create_attrs %{claimed: true, profile_picture_url: "some profile_picture_url", username: "some username"}
  ...
  describe "update user" do
    ...
    test "redirects when data is valid", %{conn: conn, user: user} do
      ...
      assert html_response(conn, 200) =~ "some updated profile_picture_url"
    end
